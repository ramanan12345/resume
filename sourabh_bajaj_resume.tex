%-------------------------
% Resume in Latex
% Author : n venkataramanan 
% License : sr manager(IT) experience above 10 + years
%------------------------
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://aurulia.tech/}{\Large N Venkataramanan}} & Email : \href{mailto:ramananpp123@gmail.com}{ramanan@gmail.com}\\
  \href{http://aurulia.tech/}{http://www.aurulia.tech} & Mobile : +91 09743282767\\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {BSc}{karnatak India}
      { Bachelar of science}{1969-1972}
    \resumeSubheading
      {bachelor of law}{KUD Dharwar, kanatak, India}
      {Bachelor of law }{1976-1979}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {LIC -Insurance domain}{karnataka,andhra}
      {CRM Initiative implemention}{three years}
      \resumeItemListStart
